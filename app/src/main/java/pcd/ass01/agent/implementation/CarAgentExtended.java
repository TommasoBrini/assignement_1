...
import pcd.ass01.environment.implementation.TrafficLightInfo;
import pcd.ass01.util.MoveForward;
...
public class CarAgentExtended extends CarAgent {
	...
	public void decide(int dt) {
		...
		if (currentSpeed > 0) {
			selectedAction = Optional.of(new MoveForward(getAgentId(), currentSpeed * dt));
		}
